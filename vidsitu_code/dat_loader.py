...
class VsituDS(Dataset):
        ...
        if is_evrel:
            ...
            for evix in [0, 1, 3, 4]:
                ...
                for vix in range(len(vid_seg_ann_lst)):
                    if self.full_cfg.train.event_sequence:
            ...
            for evix in [0, 1, 2, 3, 4]:
                ...
                for vix in range(len(vid_seg_ann_lst)):
                    if self.full_cfg.train.event_sequence:
                        ...
                        # Baseline two event attention mask
    ...
    def get_frm_feats_all(self, idx: int):
        ...
        return {"frm_feats": vid_feats, "vid_idx": master_idx}
